...
import { CopilotErrorProcessor } from '../../../../../src/processors/providers/github-copilot/metrics/error.js'
...
describe('CopilotErrorProcessor', () => {
	const processor = new CopilotErrorProcessor()
