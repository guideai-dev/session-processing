...
import { OpenCodeQualityProcessor } from '../../../../../src/processors/providers/opencode/metrics/quality.js'
...
describe('OpenCodeQualityProcessor', () => {
	const processor = new OpenCodeQualityProcessor()
