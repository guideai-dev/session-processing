...
import { OpenCodeEngagementProcessor } from '../../../../../src/processors/providers/opencode/metrics/engagement.js'
...
describe('OpenCodeEngagementProcessor', () => {
	const processor = new OpenCodeEngagementProcessor()
