            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
                ...
                <MetricCard
                  label="Context Usage"
                  value={
                    metrics.context.contextUtilizationPercent
                      ? Number.parseFloat(metrics.context.contextUtilizationPercent.toString())
                      : undefined
                  }
                  type="percentage"
                ...
                <MetricCard
                  ...
                  value={
                    metrics.context.avgTokensPerMessage
                      ? Number.parseFloat(metrics.context.avgTokensPerMessage.toString())
                      : undefined
                  }
              ...
              {/* Improvement Tips */}
              {metrics.context.improvementTips && metrics.context.improvementTips.length > 0 && (
                <div className="card bg-base-100 p-4">
                  <h4 className="font-semibold mb-3">💡 Improvement Tips</h4>
                  <ul className="text-sm space-y-1">
                    {metrics.context.improvementTips.map((tip: string) => (
                      <li key={tip} className="flex items-start">
                        <span className="text-primary mr-2">•</span>
                        {tip}
                      </li>
